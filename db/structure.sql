...
CREATE TABLE public.users (
    ...
    api_token character varying DEFAULT public.gen_random_uuid()
);
...
--
-- Name: index_addresses_on_postal_code; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_addresses_on_postal_code ON public.addresses USING btree (postal_code);
